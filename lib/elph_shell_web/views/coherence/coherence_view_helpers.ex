defmodule ElphShellWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  For example, to generate links in your layout template use:
      ElphShellWeb.Coherence.ViewHelps.coherence_links/3
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers ElphShellWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link_text})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElphShellWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElphShellWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def error_string_from_changeset(changeset) do
    Enum.map_join(changeset.errors, ". ", fn {k, v} ->
